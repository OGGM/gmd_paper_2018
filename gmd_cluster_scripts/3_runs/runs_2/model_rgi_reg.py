...
HD_OUTDIR = '/home/users/fmaussion/run_output/rgi_reg_' + rgi_reg
...
cfg.PATHS['working_dir'] = HD_OUTDIR
gdirs = workflow.init_glacier_regions(rgidf)
new_base = os.path.join(SLURM_WORKDIR, 'per_glacier')
for gdir in gdirs:
    gdir.copy_to_basedir(new_base)

# Copy the log task to append to it
shutil.copyfile(os.path.join(HD_OUTDIR, 'task_log.csv'), 
